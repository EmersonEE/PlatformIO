...
/*!
    @file     PantallitaXD.h
    @brief    Método para mostrar datos en la pantalla del "Solar Tracker".
    @details  Presenta valores de sensores, dirección y pasos en formato
              organizado, empleando múltiples áreas de visualización en pantalla.
*/
/**************************************************************************/
/**************************************************************************/
/*!
    @brief    Imprime los datos de sensores, pasos y dirección en la pantalla.
    @param    data1       Valor del sensor "AverageUp".
    @param    data2       Valor del sensor "AverageDowb".
    @param    data3       Valor del sensor "AverageLeft".
    @param    data4       Valor del sensor "AverageRight".
    @param    steps1      Conteo de pasos en el eje X.
    @param    steps2      Conteo de pasos en el eje Y.
    @param    direction   Dirección del movimiento actual del "Solar Tracker".
*/
/**************************************************************************/
void PantallitaXD::printData(float &data1, float &data2, float &data3, float &data4, int &steps1, int &steps2, int *direcction)
{
